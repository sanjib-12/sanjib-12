...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,js,py,ts,html,css,react,figma,tailwind,bootstrap,p5js,nodejs,express,django,mongodb,mysql,postgres,git,github,docker,postman,vitest,matlab,anaconda,bash)](https://skillicons.dev)
